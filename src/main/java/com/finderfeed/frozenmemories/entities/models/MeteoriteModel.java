package com.finderfeed.frozenmemories.entities.models;
...
public class MeteoriteModel extends Model {
    ...
    public static ModelLayerLocation LOCATION = new ModelLayerLocation(new ResourceLocation(FrozenMemories.MOD_ID,"meteorite"),"main");
