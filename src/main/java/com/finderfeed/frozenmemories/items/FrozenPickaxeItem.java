...
public class FrozenPickaxeItem extends PickaxeItem implements FrozenMemoriesItem {

    private int playerlvl;

    public FrozenPickaxeItem(Tier p_42961_, int p_42962_, float p_42963_, Properties p_42964_,int playerlvl) {
