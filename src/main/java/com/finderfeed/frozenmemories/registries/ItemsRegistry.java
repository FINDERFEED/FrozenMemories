...
public class ItemsRegistry {
    ...
    public static final RegistryObject<FrozenArmorItem> FROZEN_IRON_HELMET = registerItem(new FrozenArmorItem(MyArmorMaterials.IRON, EquipmentSlot.HEAD,DEFAULT.get(),ProgressionState.FOUR),"frozen_iron_helmet");
    public static final RegistryObject<FrozenArmorItem> FROZEN_IRON_CHESTPLATE = registerItem(new FrozenArmorItem(MyArmorMaterials.IRON, EquipmentSlot.CHEST,DEFAULT.get(),ProgressionState.FOUR),"frozen_iron_chestplate");
    public static final RegistryObject<FrozenArmorItem> FROZEN_IRON_LEGGINGS = registerItem(new FrozenArmorItem(MyArmorMaterials.IRON, EquipmentSlot.LEGS,DEFAULT.get(),ProgressionState.FOUR),"frozen_iron_leggings");
    public static final RegistryObject<FrozenArmorItem> FROZEN_IRON_BOOTS = registerItem(new FrozenArmorItem(MyArmorMaterials.IRON, EquipmentSlot.FEET,DEFAULT.get(),ProgressionState.FOUR),"frozen_iron_boots");

    public static final RegistryObject<FrozenArmorItem> FROZEN_DIAMOND_HELMET = registerItem(new FrozenArmorItem(MyArmorMaterials.DIAMOND, EquipmentSlot.HEAD,DEFAULT.get(),ProgressionState.SIX),"frozen_diamond_helmet");
    public static final RegistryObject<FrozenArmorItem> FROZEN_DIAMOND_CHESTPLATE = registerItem(new FrozenArmorItem(MyArmorMaterials.DIAMOND, EquipmentSlot.CHEST,DEFAULT.get(),ProgressionState.SIX),"frozen_diamond_chestplate");
    public static final RegistryObject<FrozenArmorItem> FROZEN_DIAMOND_LEGGINGS = registerItem(new FrozenArmorItem(MyArmorMaterials.DIAMOND, EquipmentSlot.LEGS,DEFAULT.get(),ProgressionState.SIX),"frozen_diamond_leggings");
    public static final RegistryObject<FrozenArmorItem> FROZEN_DIAMOND_BOOTS = registerItem(new FrozenArmorItem(MyArmorMaterials.DIAMOND, EquipmentSlot.FEET,DEFAULT.get(),ProgressionState.SIX),"frozen_diamond_boots");

    public static final RegistryObject<FrozenArmorItem> FROZEN_NETHERITE_HELMET = registerItem(new FrozenArmorItem(MyArmorMaterials.NETHERITE, EquipmentSlot.HEAD,DEFAULT.get().fireResistant(),ProgressionState.EIGHT),"frozen_netherite_helmet");
    public static final RegistryObject<FrozenArmorItem> FROZEN_NETHERITE_CHESTPLATE = registerItem(new FrozenArmorItem(MyArmorMaterials.NETHERITE, EquipmentSlot.CHEST,DEFAULT.get().fireResistant(),ProgressionState.EIGHT),"frozen_netherite_chestplate");
    public static final RegistryObject<FrozenArmorItem> FROZEN_NETHERITE_LEGGINGS = registerItem(new FrozenArmorItem(MyArmorMaterials.NETHERITE, EquipmentSlot.LEGS,DEFAULT.get().fireResistant(),ProgressionState.EIGHT),"frozen_netherite_leggings");
    public static final RegistryObject<FrozenArmorItem> FROZEN_NETHERITE_BOOTS = registerItem(new FrozenArmorItem(MyArmorMaterials.NETHERITE, EquipmentSlot.FEET,DEFAULT.get().fireResistant(),ProgressionState.EIGHT),"frozen_netherite_boots");
    ...
    public static final RegistryObject<FrozenMemoriesSword> FROZEN_IRON_SWORD = registerItem(new FrozenMemoriesSword(Tiers.IRON,4, -2.4F,new Item.Properties().tab(FrozenMemories.FROZEN_MEMORIES), ProgressionState.THREE),"frozen_iron_sword");
    public static final RegistryObject<FrozenMemoriesSword> FROZEN_DIAMOND_SWORD = registerItem(new FrozenMemoriesSword(Tiers.DIAMOND,4, -2.4F,new Item.Properties().tab(FrozenMemories.FROZEN_MEMORIES),ProgressionState.FIVE),"frozen_diamond_sword");
