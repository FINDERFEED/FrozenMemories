...
public class ItemsRegistry {
    ...
    public static RegistryObject<BlockItem> registerBlockItem(Item.Properties props,Block block, String name){
        return ITEMS.register(name,()->new BlockItem(block,props));
    }
